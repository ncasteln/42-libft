...
// FT_STRITERI HELPER FUNCTION
// static void	print_s_iteri(unsigned int i, char *s) {
// 	printf("Iteration n %d: char %c transformed into %c\n", i, *(s + i), ft_toupper(*(s + i)));
// 	ft_toupper(*(s + i));
// }

// FT_STRITERI ZERO HELPER FUNCTION
// static void	zero_iteri(unsigned int i, char *s) { i = 0; *s = 0; }

// FT_STRMAPI HELPER FUNCTION
...
// FT_LSTDELONE AND FT_LSTCLEAR HELPER FUNCTION
...
int main ()
{
	...
	// char *src = "Cas tel";
	// char dest[15] = "Nico";
	// size_t tried = ft_strlcat(dest, src, 15);
	// printf("dest_size = %lu\n", tried);
