...
int main ()
{
	...
	// 	printf("ft_strlcat has concatenated the whole src to dest!");
	// }
	// else
	// {
	// 	printf("ft_strlcat tried to create a string of %lu chars, but not the whole src was concatenated to dest: dest is %s \n", result, dest);
	// }
...
// __________________BONUS PART_________________________
	...
	// ft_calloc(20, sizeof(int));
	// ft_calloc(20, sizeof(char));
	// ft_calloc(67280421310720, 274177);
	// printf("Result of limit:\n");
	// ft_calloc(67280421310721, 274177);
	// printf("More than the limit:\n");
	// ft_calloc(67280421310722, 274178);
	// // printf("(len * n_bits) / len = %lu\n", ( len * n_bits )/ len);
	// // printf("(len * n_bits) / n_bits = %lu\n", ( len * n_bits )/ n_bits);
